...
func main() {
	...
	cfg := EmailConfig{
		...
		SMTPPort:    587,
		Username:    envOrDefault("GMAIL_USER", "your-email@example.com"),
		AppPassword: os.Getenv("GMAIL_APP_PASSWORD"),
		FromAddr:    envOrDefault("GMAIL_USER", "your-email@example.com"),
		Recipients:  parseRecipients(envOrDefault("NEWSLETTER_RECIPIENTS", "your-email@example.com,your-email@example.com")),
	}
